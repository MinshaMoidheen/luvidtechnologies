...
const ContactPage = () => {
  ...
  useEffect(() => {
    ...
    if (tabParam === "quote") {
      setActiveTab(0); // "Get a Quote" is the first tab
    } else if (tabParam === "partnership") {
      setActiveTab(1); // "Partnership" is the second tab
    } else if (tabParam === "enquiry") {
      setActiveTab(2); // "General Enquiry" is the third tab
    } else {
      // Default to "General Enquiry" (third tab) when no parameter or unknown parameter
      setActiveTab(2);
    }
  }, [searchParams]);
        ...
        <div className="contact-row">
          <div className="contact-left">
            ...
            <p className="contact-desc">
              We'd love to hear about your digital project. Please get in touch
              with one of our Project Consultants.
            </p>
          ...
          <div className="contact-right">
            ...
            <form className="contact-form" autoComplete="off">
              ...
              <div className="contact-form-group">
                ...
                ></textarea>
                <div className="contact-form-count">
                  {message.length} / 1000
                </div>
              </div>
            </form>
